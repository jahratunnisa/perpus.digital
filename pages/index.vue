      ...
      <div class="col-lg-12">
        ...
        <form @submit.prevent="kirimData">
          <div class="row">
            <div class="col-md-8">
              <div class="mb-3">
                <input type="text" v-model="form.nama" class="form-nama form-control form-control-lg rounded-5"
                  placeholder="NAMA" />
              </div>
              <div class=" mb-3">
              ...
              <div v-if="form.keanggotaan == '2'" class="grup-option">
                <div class="col-lg">
              ...
              <div class="col">
                ...
                class="btn justify-content-center btn-light btn-lg rounded-5 px-5 mr">Kirim</button>
              </div>

            </div>
            <div class="col-md-4">
              <img src="~/assets/img/img-kunjungan.png" alt="gambar tambah kunjungan" />
            </div>
          </div>
          <div class="mb-3">
            <div class="row">
